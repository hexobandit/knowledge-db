...
Now to see actually anything useful you need to follow each control:
...
├──────────┼─────────────────────┼────────────────────────────────────┼──────────────────────────────────────────────────────┤
│ Medium   │ Non-root containers │ https://hub.armosec.io/docs/c-0013 │ spec.containers[0].securityContext.runAsNonRoot=true │
